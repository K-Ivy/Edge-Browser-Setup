...
**Extension & Theme Installation** > 
 1. Enable "Developer mode" on the [Extensions](edge://extensions/) page,
...
- Disable JavaScript, Images, Background Sync, Payment Handlers, Clipboard Access by default (alongside most others).
